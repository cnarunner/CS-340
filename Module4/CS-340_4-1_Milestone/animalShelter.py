...
dft = df[["age_upon_outcome", "animal_id", "animal_type", "breed", "color", "date_of_birth", "name", "outcome_type", "sex_upon_outcome"]]
...
def update_graphs(viewData):
    ...
    if graph_type is 0:
        ...
        # graph.update_layout(show_legend = False)
